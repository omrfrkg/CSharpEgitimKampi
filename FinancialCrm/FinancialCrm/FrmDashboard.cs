...
namespace FinancialCrm
{
    public partial class FrmDashboard : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if(count % 4 == 1)
            {
                var elektrikFaturasi = db.TblBills.Where(x => x.BillTitle == "Elektrik Faturası").Select(y => y.BillAmount).FirstOrDefault();
            ...
            if (count % 4 == 2)
            {
                var elektrikFaturasi = db.TblBills.Where(x => x.BillTitle == "Doğalgaz Faturası").Select(y => y.BillAmount).FirstOrDefault();
            ...
            if (count % 4 == 3)
            {
                var elektrikFaturasi = db.TblBills.Where(x => x.BillTitle == "Su Faturası").Select(y => y.BillAmount).FirstOrDefault();
            ...
            if (count % 4 == 0)
            {
                var elektrikFaturasi = db.TblBills.Where(x => x.BillTitle == "İnternet Faturası").Select(y => y.BillAmount).FirstOrDefault();
